...
file_name = "netstat_data_relay_BHost_four_"+yesterday+".json"
ip_name = "netstat_data_relay_BHost_four_"+yesterday+".txt"
...
ip_name_formatted = "netstat_data_relay_BHost_four_"+yesterday+"_formatted.txt"
...
dns_records = "netstat_data_relay_BHost_four_"+yesterday+"_dns_records.txt"
...
asn_records = "netstat_data_relay_BHost_four_"+yesterday+"_asn_records.txt"
